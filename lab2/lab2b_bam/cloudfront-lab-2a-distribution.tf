...
resource "aws_cloudfront_distribution" "dawgs-armageddon_cf01" {
  ...
  # S3 origin is a sibling of the ALB origin — both are top-level origin {}
  # blocks inside the distribution resource. OAC handles request signing to
  # S3; no custom_origin_config is needed or valid for S3 origins.
  origin {
